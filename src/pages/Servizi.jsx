...
const services = [
  ...
  },
  {
    ...
    points: [
      'Strutture in zirconia e cromo cobalto fresate in house',
  ...
  },
  {
    ...
    points: [
      'Ceramiche CZR/Noritake e Ivoclar',
  ...
  {
    icon: Wrench,
    title: 'Provvisori fresati e stampati',
    desc: 'Provvisori a lunga durata e rifiniti esclusivamente a mano. Una superficie lucidata correttamente riduce l’accumulo di placca e permette di validare estetica e funzione prima del definitivo.',
    points: [
      'Fresati e stampati',
      'Rifinitura e lucidatura a mano',
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Laboratorio odontotecnico per studi di Belluno e tutto il territorio nazionale: corone e ponti in zirconia, full arch, faccette, provvisori e chirurgia guidata con workflow digitale."
      />
