        ...
        <div className="text-center max-w-5xl mx-auto mb-16">
          <div className="space-y-3">
            ...
            <motion.h2 {...fade(0.08)} className="text-4xl font-bold text-primary-dark leading-tight">
              Laboratorio odontotecnico per studi di Belluno e tutto il territorio nazionale
            </motion.h2>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 lg:gap-5">
          ...
          >
            <img
              ...
              alt="Laboratorio odontotecnico EFFE2 a Ponte nelle Alpi, provincia di Belluno"
          ...
          >
            ...
            <div className="space-y-4 mt-8">
              ...
              <p className="text-sm text-muted leading-relaxed">
                Ogni manufatto è controllato prima della spedizione. Collaborazioni durature con studi in tutto il territorio nazionale.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-4xl font-bold text-primary-dark tabular-nums">1–3</p>
            <p className="text-sm text-primary-dark/60 leading-relaxed mt-2">
              Giorni lavorativi dalla spedizione, grazie al workflow digitale.
            </p>
          </motion.div>
